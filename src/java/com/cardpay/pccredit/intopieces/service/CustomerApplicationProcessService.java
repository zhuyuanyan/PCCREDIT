...
public class CustomerApplicationProcessService {
	 ...
	 * @param fuheUser
	 */
	public void addfuheProcess(String fuheUser,String processId){
			CustomerApplicationProcess process = commonDao.findObjectById(CustomerApplicationProcess.class, processId);
			process.setFuheUser(fuheUser);
