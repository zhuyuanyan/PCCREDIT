...
public class PbocFileReader {
	...
	* @throws SQLException 
	*/
	private static List<Element> content_Element_List = null;
	...
	* @return YH_Info
	*/
	public static RH_YH_INFO readYH(String url)
	{
	...
	* @return PO_Info
	*/
	public static RH_PO_INFO readPO(String url)
	{
		//List<Element> content_Element_List = readUrl(url);
	...
	* @return List<JZ_Info>
	*/
	public static List<RH_JZ_INFO> readJZ(String url)
	{
		//List<Element> content_Element_List = readUrl(url);
		/** start **/
	...
	* @return List<ZY_Info>
	*/
	public static List<RH_ZY_INFO> readZY(String url)
	{
		//List<Element> content_Element_List = readUrl(url);
	...
	* @return XYTS_Info
	*/
	public static RH_XYTS_INFO readXYTS(String url)
	{
		//List<Element> content_Element_List = readUrl(url);
	...
	* @return YQ_Info
	*/
	public static RH_YQ_INFO readYQ(String url)
	{
		//List<Element> content_Element_List = readUrl(url);
	...
	* @Return WJQDK_Info
	*/
	public static RH_WJQDK_INFO readWJQDK(String url)
	{
		//List<Element> content_Element_List = readUrl(url);
	...
	* @return WXHDJK_Info
	*/
	public static RH_WXHDJK_INFO readWXHDJK(String url)
	{
		//List<Element> content_Element_List = readUrl(url);
		
		/** start **/
		RH_WXHDJK_INFO wxhdjk_Info = new RH_WXHDJK_INFO();
	...
	* @return DWDB_Info
	*/
	public static RH_DWDB_INFO readDWDB(String url)
	{
		//List<Element> content_Element_List = readUrl(url);
		
		/** start **/
		RH_DWDB_INFO dwdb_Info = new RH_DWDB_INFO();
	...
	* @return Query_Info
	*/
	public static RH_QUERY_INFO readQuery(String url)
	{
		//List<Element> content_Element_List = readUrl(url);
