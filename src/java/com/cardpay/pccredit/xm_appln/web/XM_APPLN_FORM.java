...
public class XM_APPLN_FORM extends BaseForm {
	...
	public List<XM_APPLN_KPMX> createXM_APPLN_KPMX(String userId){
		...
		obj.setAtm(atm2);
		obj.setCdesploc(cdesploc2);
		obj.setCdespmtd(cdespmtd2);
		obj.setCdfrm(cdfrm2);
		obj.setCourierf(courierf2);
		obj.setCred_lmt(cred_lmt2);
		obj.setCustomer_id(customer_id);
		obj.setCustr_nbr(custr_nbr2);
		obj.setEmbname_d(embname_d2);
		obj.setEmboss_cd(emboss_cd2);
		obj.setLsh(1);
		obj.setNet(net2);
		obj.setPhone(phone2);
		obj.setPin_chk(pin_chk2);
		obj.setPin_reqd(pin_reqd2);
		obj.setPpno(ppno2);
		obj.setSms_yn(sms_yn2);
		obj.setSpec_inst(spec_inst2);
		obj.setTele(tele2);
		obj.setCreatedBy(userId);
		ls.add(obj2);
		...
		if(Integer.parseInt(cardCount)>2){
			...
			obj.setAtm(atm3);
			obj.setCdesploc(cdesploc3);
			obj.setCdespmtd(cdespmtd3);
			obj.setCdfrm(cdfrm3);
			obj.setCourierf(courierf3);
			obj.setCred_lmt(cred_lmt3);
			obj.setCustomer_id(customer_id);
			obj.setCustr_nbr(custr_nbr3);
			obj.setEmbname_d(embname_d3);
			obj.setEmboss_cd(emboss_cd3);
			obj.setLsh(2);
			obj.setNet(net3);
			obj.setPhone(phone3);
			obj.setPin_chk(pin_chk3);
			obj.setPin_reqd(pin_reqd3);
			obj.setPpno(ppno3);
			obj.setSms_yn(sms_yn3);
			obj.setSpec_inst(spec_inst3);
			obj.setTele(tele3);
			obj.setCreatedBy(userId);
			ls.add(obj3);
		}
		if(Integer.parseInt(cardCount)>3){
			...
			obj.setAtm(atm4);
			obj.setCdesploc(cdesploc4);
			obj.setCdespmtd(cdespmtd4);
			obj.setCdfrm(cdfrm4);
			obj.setCourierf(courierf4);
			obj.setCred_lmt(cred_lmt4);
			obj.setCustomer_id(customer_id);
			obj.setCustr_nbr(custr_nbr4);
			obj.setEmbname_d(embname_d4);
			obj.setEmboss_cd(emboss_cd4);
			obj.setLsh(3);
			obj.setNet(net4);
			obj.setPhone(phone4);
			obj.setPin_chk(pin_chk4);
			obj.setPin_reqd(pin_reqd4);
			obj.setPpno(ppno4);
			obj.setSms_yn(sms_yn4);
			obj.setSpec_inst(spec_inst4);
			obj.setTele(tele4);
			obj.setCreatedBy(userId);
			ls.add(obj4);
		}
		if(Integer.parseInt(cardCount)>4){
			...
			obj.setAtm(atm5);
			obj.setCdesploc(cdesploc5);
			obj.setCdespmtd(cdespmtd5);
			obj.setCdfrm(cdfrm5);
			obj.setCourierf(courierf5);
			obj.setCred_lmt(cred_lmt5);
			obj.setCustomer_id(customer_id);
			obj.setCustr_nbr(custr_nbr5);
			obj.setEmbname_d(embname_d5);
			obj.setEmboss_cd(emboss_cd5);
			obj.setLsh(4);
			obj.setNet(net5);
			obj.setPhone(phone5);
			obj.setPin_chk(pin_chk5);
			obj.setPin_reqd(pin_reqd5);
			obj.setPpno(ppno5);
			obj.setSms_yn(sms_yn5);
			obj.setSpec_inst(spec_inst5);
			obj.setTele(tele5);
			obj.setCreatedBy(userId);
			ls.add(obj5);
		}
		if(Integer.parseInt(cardCount)>5){
			...
			obj.setAtm(atm6);
			obj.setCdesploc(cdesploc6);
			obj.setCdespmtd(cdespmtd6);
			obj.setCdfrm(cdfrm6);
			obj.setCourierf(courierf6);
			obj.setCred_lmt(cred_lmt6);
			obj.setCustomer_id(customer_id);
			obj.setCustr_nbr(custr_nbr6);
			obj.setEmbname_d(embname_d6);
			obj.setEmboss_cd(emboss_cd6);
			obj.setLsh(5);
			obj.setNet(net6);
			obj.setPhone(phone6);
			obj.setPin_chk(pin_chk6);
			obj.setPin_reqd(pin_reqd6);
			obj.setPpno(ppno6);
			obj.setSms_yn(sms_yn6);
			obj.setSpec_inst(spec_inst6);
			obj.setTele(tele6);
			obj.setCreatedBy(userId);
			ls.add(obj6);
		}
		if(Integer.parseInt(cardCount)>6){
			...
			obj.setAtm(atm7);
			obj.setCdesploc(cdesploc7);
			obj.setCdespmtd(cdespmtd7);
			obj.setCdfrm(cdfrm7);
			obj.setCourierf(courierf7);
			obj.setCred_lmt(cred_lmt7);
			obj.setCustomer_id(customer_id);
			obj.setCustr_nbr(custr_nbr7);
			obj.setEmbname_d(embname_d7);
			obj.setEmboss_cd(emboss_cd7);
			obj.setLsh(6);
			obj.setNet(net7);
			obj.setPhone(phone7);
			obj.setPin_chk(pin_chk7);
			obj.setPin_reqd(pin_reqd7);
			obj.setPpno(ppno7);
			obj.setSms_yn(sms_yn7);
			obj.setSpec_inst(spec_inst7);
			obj.setTele(tele7);
			obj.setCreatedBy(userId);
			ls.add(obj7);
		}
		if(Integer.parseInt(cardCount)>7){
			...
			obj.setAtm(atm8);
			obj.setCdesploc(cdesploc8);
			obj.setCdespmtd(cdespmtd8);
			obj.setCdfrm(cdfrm8);
			obj.setCourierf(courierf8);
			obj.setCred_lmt(cred_lmt8);
			obj.setCustomer_id(customer_id);
			obj.setCustr_nbr(custr_nbr8);
			obj.setEmbname_d(embname_d8);
			obj.setEmboss_cd(emboss_cd8);
			obj.setLsh(7);
			obj.setNet(net8);
			obj.setPhone(phone8);
			obj.setPin_chk(pin_chk8);
			obj.setPin_reqd(pin_reqd8);
			obj.setPpno(ppno8);
			obj.setSms_yn(sms_yn8);
			obj.setSpec_inst(spec_inst8);
			obj.setTele(tele8);
			obj.setCreatedBy(userId);
			ls.add(obj8);
		}
		if(Integer.parseInt(cardCount)>8){
			...
			obj.setAtm(atm9);
			obj.setCdesploc(cdesploc9);
			obj.setCdespmtd(cdespmtd9);
			obj.setCdfrm(cdfrm9);
			obj.setCourierf(courierf9);
			obj.setCred_lmt(cred_lmt9);
			obj.setCustomer_id(customer_id);
			obj.setCustr_nbr(custr_nbr9);
			obj.setEmbname_d(embname_d9);
			obj.setEmboss_cd(emboss_cd9);
			obj.setLsh(8);
			obj.setNet(net9);
			obj.setPhone(phone9);
			obj.setPin_chk(pin_chk9);
			obj.setPin_reqd(pin_reqd9);
			obj.setPpno(ppno9);
			obj.setSms_yn(sms_yn9);
			obj.setSpec_inst(spec_inst9);
			obj.setTele(tele9);
			obj.setCreatedBy(userId);
			ls.add(obj9);
		}
